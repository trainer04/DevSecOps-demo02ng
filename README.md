...
Use the https://nvd.nist.gov/developers/request-an-api-key link to obtain the NVD key. Then you may create the <b>'NVD-key'</b> parameter using the same way as for the key password above<br>
